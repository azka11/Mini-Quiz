...
import { loginAdmin } from "../modules/fetch/admin";
...
function AdminLogin() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
          ...
          const { token, currentAdmin, adminId } = response
          Cookies.set("token", token, { expires: 1 })
          Cookies.set("currentAdmin", currentAdmin, { expires: 1 })
    ...
    <div className="bg-[#4b54cd] rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
            ...
            <form id="login-form" className="flex flex-col gap-4" onSubmit={handleLogin}>
                <input className="p-2 mt-8 rounded-xl border" type="name" name="name" placeholder="Name" />
